...
ret, bw_img = cv2.threshold(img2,170,255,cv2.THRESH_BINARY) 	    # setting a threshold for mask here 170 is the threshold set you have to choose your own value.		
cv2.imwrite('binary_mask1.jpg',bw_img)		# save the binary mask in a local path
maskpath='...../binary_mask1.jpg'
mask = cv2.imread(maskpath,0) 


#using inpaint function remove the mask from the original image 
